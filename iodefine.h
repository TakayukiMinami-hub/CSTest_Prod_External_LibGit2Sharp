...
*/
/******************************************************************************/
/* Device     : RL78/R7F0C008A                                                */
/* File Name  : iodefine.h                                                    */
/* Abstract   : Definition of Special Function Register (SFR)                 */
/* History    : E1.00f [Device File version]                                  */
/* Options    : -df=D:\csp_release2\CS+\CC\Device_Custom\RL78\Devicefile\DR5F */
/*              C008A.DVF -o=C:\Users\a5047420\Documents\csplus_Uad_external_ */
/*              LibGit2Sharp\iodefine.h -f                                    */
/* Date       : 2026/09/09                                                    */
/* Version    : V1.21.00.01  [df2iodef.exe version]                           */
/* This is a typical example.                                                 */
/*                                                                            */
/******************************************************************************/
#ifndef __R7F0C008AIODEFINE_HEADER__
#define __R7F0C008AIODEFINE_HEADER__
...
#define OACMPEN      (((volatile __near __bitf_T *)0x7A)->no5)
#define PWMOPEN      (((volatile __near __bitf_T *)0x7A)->no6)
...
#define OPMR         (*(volatile __near unsigned char  *)0x26C)
#define OPSR         (*(volatile __near unsigned char  *)0x26D)
#define OPHS         (*(volatile __near unsigned char  *)0x26E)
#define OPHT         (*(volatile __near unsigned char  *)0x26F)
...
#define MRTRDGRC0    (*(volatile __near unsigned short *)0x27C)
#define MRTRDGRD0    (*(volatile __near unsigned short *)0x27E)
...
#define MRTRDGRC1    (*(volatile __near unsigned short *)0x28C)
#define MRTRDGRD1    (*(volatile __near unsigned short *)0x28E)
...
#define CVRCTL       (*(volatile __near unsigned char  *)0x343)
#define CVRCTL_bit   (*(volatile __near __bitf_T *)0x343)
#define CVRE0        (((volatile __near __bitf_T *)0x343)->no1)
#define CVRE1        (((volatile __near __bitf_T *)0x343)->no5)
#define C0RVM        (*(volatile __near unsigned char  *)0x344)
#define C1RVM        (*(volatile __near unsigned char  *)0x345)
#define PGACTL       (*(volatile __near unsigned char  *)0x346)
#define PGACTL_bit   (*(volatile __near __bitf_T *)0x346)
#define PGAEN        (((volatile __near __bitf_T *)0x346)->no7)
